...
function Keraate_app() {
  return (
    <>
      <Col>
        <div className="app_text text-center">
          <h1 className="fs-1 fw-bold   mb-3">تطبيق قراءتي</h1>
          <p>
            فى إطار حرص الشركة القابضة على ميكنة الخدمات، أطلقت تطبيق «قراءتى»
            والذى يتيح للمواطن تسجيل قراءة العداد بنفسه، وإضافة صورة العداد ما
            يضمن دقة القراءة، ويمكن للمواطن تسجيل القراءات شهريا خلال الفترة من
            يوم 1 إلى 15 من كل شهر. ويمكن للمواطن تحميل التطبيق من خلال Google
            play مجانًا،
          </p>
